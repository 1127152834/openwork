...
export default function PluginsView(props: PluginsViewProps) {
  ...
  const translateMaybeKey = (value: string) => (value.startsWith("constants.") ? translate(value) : value);
                  ...
                  <div class="rounded-2xl border border-gray-6/60 bg-gray-1/40 p-4 space-y-3">
                    <div class="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <div class="text-xs text-gray-10 mt-1">{translateMaybeKey(plugin.description)}</div>
                            ...
                            <div class="space-y-1">
                              ...
                              <Show when={step.url}>
                                <div class="text-xs text-gray-10">
                                  {translate("common.open")}: <span class="font-mono text-gray-11">{step.url}</span>
                                </div>
                              </Show>
                              <Show when={step.path}>
                                <div class="text-xs text-gray-10">
                                  {translate("common.path")}: <span class="font-mono text-gray-11">{step.path}</span>
                                </div>
                              </Show>
                            </div>
                          )}
        ...
        <Show
          ...
          fallback={
            <div class="rounded-xl border border-gray-6/60 bg-gray-1/40 p-4 text-sm text-gray-10">
              {translate("plugins.no_plugins_yet")}
            </div>
          }
        >
