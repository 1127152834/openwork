              ...
              <div class="flex items-start justify-between gap-3">
                <div class="min-w-0">
                  <div class="text-xs font-semibold text-gray-12 flex items-center gap-2">
                    ...
                    {translate("create_workspace_modal.sandbox_setup")}
                  </div>
                ...
                >
                  {showProgressDetails() ? translate("create_workspace_modal.hide_logs") : translate("create_workspace_modal.show_logs")}
                </button>
              </div>
              ...
              <Show when={showProgressDetails() && (p().logs?.length ?? 0) > 0}>
                <div class="mt-3 rounded-lg border border-gray-6 bg-black/5 px-3 py-2 animate-in fade-in">
                  <div class="flex justify-between items-center mb-2">
                    <div class="text-[10px] uppercase tracking-wide font-semibold text-gray-10">{translate("create_workspace_modal.live_logs")}</div>
                  </div>
          ...
          <div class="rounded-xl border border-amber-7/30 bg-amber-2/40 px-4 py-3 text-xs text-amber-11">
            ...
            <Show when={workerDebugLines().length > 0}>
              <details class="mt-3 rounded-lg border border-gray-6 bg-gray-2/60 px-3 py-2 text-[11px] text-gray-11">
                <summary class="cursor-pointer text-xs font-semibold text-gray-12">{translate("create_workspace_modal.docker_debug_details")}</summary>
        ...
        <div class="flex justify-end gap-3">
          ...
          >
            <Show when={submitting()} fallback={confirmLabel()}>
              <span class="inline-flex items-center gap-2">
                <Loader2 size={16} class="animate-spin" />
                {translate("create_workspace_modal.creating")}
              </span>
            </Show>
          </Button>
        </div>
